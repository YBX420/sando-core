...
case "$ARM" in
  ...
  stc)     ENVS="THIN=1 ST_COMMIT=1";                  SEEDS=$(seq 0 19) ;;   # M3 commitment arm
  stck10)  ENVS="THIN=1 ETA_FEED=2 ETA_K=1.0 ST_COMMIT=1"; SEEDS=$(seq 0 19) ;;  # M3 x sigma-margin
  ...
  orastc)  ENVS="ORACLE_THIN=1 ST_COMMIT=1";           SEEDS="3 7 11 15 19" ;;  # commitment meat under god-view
