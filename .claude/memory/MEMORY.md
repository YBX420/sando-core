> **⚠️ 2026-06-23 方向再聚焦(最新,覆盖下面 6-22 的 headline):产品 = 认证的「最快+最安全绕行」(certified go-around),不是判官只 HOLD;只做 EGO(MINCO 暂搁置);KF(CA)预测障碍未来→喂预测占据给 EGO 绕开未来→证书检预测移动球→过则飞;planner 无关降为支撑性质,不是 headline。** M1 已跑通,见 [sando-core-goaround-m1-2026-06](sando-core-goaround-m1-2026-06.md) + [sando-core-direction-2026-06](sando-core-direction-2026-06.md) 的 6/23 块。诚实点:q_conformal=0 → 几何证书 + 预测误差吃 d_safe(净空 0.677<0.8)。
>
